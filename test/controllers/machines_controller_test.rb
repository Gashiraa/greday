...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { brand: @machine.brand, hours: @machine.hours, km: @machine.km, model: @machine.model, year: @machine.year } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { brand: @machine.brand, hours: @machine.hours, km: @machine.km, model: @machine.model, year: @machine.year } }
